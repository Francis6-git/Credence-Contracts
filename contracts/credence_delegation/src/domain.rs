...
///
/// Panics with the generic delegation nonce error on any mismatch.
/// This keeps the externally visible failure mode stable and avoids leaking
/// which payload field differed.
