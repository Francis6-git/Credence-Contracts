...
| 7. Withdraw Early | `credence_bond` | `contracts/credence_bond/src/lib.rs` | `withdraw_early` | 763 | **Simplified** | Calculates and emits early-exit penalty, but neither transfers the remainder to the user nor the penalty to the treasury. |
